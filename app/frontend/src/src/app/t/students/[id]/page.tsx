                                ...
                                <>
                                    ...
                                    <Card className="flex flex-col p-6 gap-6">
                                        <div>
                                            ...
                                            <div className="flex gap-6">
                                                <UserIcon user={{id: user.id, mail: (user?.master_mail.Valid ? user?.master_mail.String : ''), name: (user?.master_name.Valid ? user?.master_name.String : '') }} size="4rem" className="text-xl" />
                                                <div className="flex flex-col justify-around">
